...
@EnableJpaRepositories(basePackages = {"com.lk.cc.bcon.finance" })
...
public class SysConfig {
	...
	*//** The Constant JPA_ENTITY_PACKAGES. *//*
	private static final String[] JPA_ENTITY_PACKAGES = { "com.lk.cc.bcon.finance.entity" };
	...
	*//** The Constant jndiNamespace. *//*
	...
	public DataSource dataSource() {
	    ...
	    dataSource.setUrl("jdbc:postgresql://localhost:5432/bcon-finance");
